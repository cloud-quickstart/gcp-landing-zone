...
// from
// https://github.com/GoogleCloudPlatform/java-docs-samples/blob/826cfbefa10e4eb353241f97e48b4bfbbf05e0cb/iam/api-client/pom.xml
...
public class Cli {
    ...
    public static void main(String[] args) {
       // Credentials credentials = null;
        ...
        String projectId = "projects/lz-stg";
